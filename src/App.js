...
import { addFeatures, removeFeatures, updateTotal } from '../src/components/actions'
...
export default connect(mapStateToProps, { addFeatures, removeFeatures, updateTotal })(App)
// export default App;
